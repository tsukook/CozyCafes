...
public class ItemRegistry {
    ...
    public static final DeferredItem<BlockItem> COFFEE_PLANT = ITEMS.registerSimpleBlockItem(BlockRegistry.COFFEE_PLANT);
    public static final DeferredItem<BlockItem> COFFEE_PULPER = ITEMS.registerSimpleBlockItem(BlockRegistry.COFFEE_PULPER);
